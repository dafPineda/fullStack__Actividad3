...
- Las modificaciones son parciales. Solo se modifca los campos que el usuario envia.

Durante el procedimiento se uso la libreria npm. Se uso express y --sev-dev donemon durante el desarrollo para facilitar pruebas y crear servidores efímeros de uso local.
